...
('아메리카노 (ICE)', '시원하고 깔끔한 맛의 에스프레소 커피', 4000, NULL, 100),
('카페라떼 (HOT)', '따뜻한 우유와 에스프레소의 부드러운 조화', 5000, NULL, 100),
('바닐라 라떼 (ICE)', '달콤한 바닐라 시럽이 더해진 시원한 라떼', 5500, NULL, 50),
('카라멜 마끼아또', '카라멜 소스와 우유 거품이 어우러진 달콤한 커피', 5800, NULL, 40),
('자몽 허니 블랙티', '자몽의 상큼함과 꿀의 달콤함이 담긴 블랙티', 6000, NULL, 30);
